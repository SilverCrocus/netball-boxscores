/**
 * Client-safe live win probability model for Super Netball.
 *
 * This module intentionally has no server or framework imports. Keep the
 * calculation here so client bundles can use it without pulling in the
 * server-side historical-data query and its dependencies.
 *
